...
- Preserve 55% Showcase music ducking, 280ms fade-down, 900ms recovery, and normal-speed pre-generated Showcase narration.
...
- Keep backend, API, account, LLM and private profile logic out of static Showcase code.

## Verification

- Write failing behavior tests before production code.
- Run focused tests, `npx tsx --test`, `npm run build`, and `npm run showcase:scan-build` before a phase claim.
